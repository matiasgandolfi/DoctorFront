      ...
      this._especialidadServicio.crear(especialidad).subscribe({
        next: (data) => {
          if(data.isExitoso)
          {
            ...
            this._compartidoService.mostrarAlerta('No se puede crear la especialidad', 'Error!');
          }
        },
        error: (e) => {
      ...
      this._especialidadServicio.editar(especialidad).subscribe({
        next: (data) => {
          if(data.isExitoso)
          {
            ...
            this._compartidoService.mostrarAlerta('No se puede actualizar la especialidad', 'Error!');
          }
        },
        error: (e) => {}
      })
